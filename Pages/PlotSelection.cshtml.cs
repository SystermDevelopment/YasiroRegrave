...
namespace YasiroRegrave.Pages
{
    public class PlotSelectionModel : PageModel
    {
        ...
        public void GetPage()
        {
            ...
            ReienIndex = 0;
            AreaIndex = 0;
            ReienCode = _context.Reiens.FirstOrDefault(r => r.ReienIndex == ReienIndex && r.DeleteFlag == (int)Config.DeleteType.ñ¢çÌèú)?.ReienCode ?? "";
            ReienName = _context.Reiens.FirstOrDefault(r => r.ReienIndex == ReienIndex && r.DeleteFlag == (int)Config.DeleteType.ñ¢çÌèú)?.ReienName ?? "";
            ...
            foreach (var section in SectionDatas)
            {
                ...
                section.NoReserveCount = _context.CemeteryInfos
                                            .Count(c => c.Cemetery.SectionIndex == section.SectionIndex
                                                && c.Cemetery.DeleteFlag == (int)Config.DeleteType.ñ¢çÌèú
                                                && c.DeleteFlag == (int)Config.DeleteType.ñ¢çÌèú
