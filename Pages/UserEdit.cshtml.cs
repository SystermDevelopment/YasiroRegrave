    ...
    public class UserEditModel : PageModel
    {
        ...
        public IActionResult OnGet(int? index)
        {
            ...
            if (index.HasValue)
            {
                var user = _context.Users
                    .Where(u => u.UserIndex == Index && u.DeleteFlag == (int)Config.DeleteType.未削除)
                    .FirstOrDefault();
                if (user != null)
                {
                    Id = user.Id;
        ...
        public IActionResult OnPost(int? index)
        {
            ...
            try
            {
                ...
                {
                    var existingUser = _context.Users.FirstOrDefault(v => v.DeleteFlag == (int)Config.DeleteType.未削除 && v.UserIndex == index.Value);
